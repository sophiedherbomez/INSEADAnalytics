...
**Your Answers here:**
<br>1. change the start date to 2000-12-29 l9. We can only get it from 2001-01-02 because there is no trading on 2001-01-01 and the last day the stock exchange was open was 2000-12-29
<br>
...
pnl_plot(SPY)
```
<br>2. adapt StartDate and create EndDate to get the wished data range (adapt using from StartDate to EndDate), adapt myticker to have the symbols of the various companies we want, and create the equally weighted portfolio portfolio = apply(StockReturns,1,mean). Then plot it.
<br>
